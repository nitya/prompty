...
### Step 2: Define the Hugging Face Invoker Class
...
### Step 3: Register the Hugging Face Invoker
...
### Step 4: Use the Hugging Face Invoker
...
### Example : A `basic_hf.prompty` asset
